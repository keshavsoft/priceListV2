...
async function ensureKSHeader() {
    ...
    async function tryGitHub() {
        try {
            const fromPromise = await loadScriptAsModule("https://keshavsoft.github.io/tailwind-header-dom/Public/v4.6/ksheader.js");
    ...
    async function tryLocal() {
        try {
            ...
            console.log("KSHeader loaded from local");
